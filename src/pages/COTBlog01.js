  ...
  return (
    <COTBlog01Styled>
      ...
      <Container>
        ...
        <marquee><h3><a href="https://cmt3.research.microsoft.com/CoT2023" target="_blank" rel="noopener noreferrer">Click here</a> to submit your chapter.</h3></marquee>
        ...
        <div className="submission">
          ...
          <p>
            ...
            LaTeX: <a href="https://www.overleaf.com/latex/templates/taylor-and-francis-latex-template-for-authors-interact-layout-plus-apa-reference-style/jqhskrsqqzfz" target="_blank" rel="noopener noreferrer">https://www.overleaf.com/latex/templates/taylor-and-francis-latex-template-for-authors-interact-layout-plus-apa-reference-style/jqhskrsqqzfz</a> <br/>
            Microsoft Office Word: <a href="https://docs.google.com/document/d/1DKIFZAqO2LzzrurzeOFbSDh2qzL_tOo_/edit?usp=share_link&ouid=109550927316957289401&rtpof=true&sd=true" target="_blank" rel="noopener noreferrer">https://docs.google.com/document/d/1DKIFZAqO2LzzrurzeOFbSDh2qzL_tOo_/edit?usp=share_link&ouid=109550927316957289401&rtpof=true&sd=true</a> <br/>
          </p>
        </div>
        ...
        <div className="editors">
          ...
          <ol className="editor">
            <li>
              Dr. Jitendra Kumar, National Institute of Technology Tiruchirappalli, India [<a href = "mailto: jitendra@nitt.edu">jitendra@nitt.edu</a>]
            </li>
            <li>
              Dr. G. R. Gangadharan, National Institute of Technology Tiruchirappalli, India [<a href = "mailto: ganga@nitt.edu">ganga@nitt.edu</a>]
            </li>
            <li>
              Prof. Ashutosh Kumar Singh, National Institute of Technology Kurukshetra, India [<a href = "mailto: ashutosh@nitkkr.ac.in">ashutosh@nitkkr.ac.in</a>]
            </li>
            <li>
              Prof. Chung-Nan Lee, National Sun Yat-sen University, Kaohsiung, Taiwan [<a href = "mailto: cnlee@mail.cse.nsysu.edu.tw">cnlee@mail.cse.nsysu.edu.tw</a>]
            </li>
          </ol>
        </div>
